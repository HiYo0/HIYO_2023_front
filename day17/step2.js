/* 
    JS 자료형
        ...
        5. 배열(array)      [ 자료, 자료, 자료 ]
                            - 1. [숫자, 문자열, 불, 배열]
                            - 2. [ 숫자, 문자열, 불, 배열, 배열, 변수, 상수, 함수 ]
        6. 함수             function
                            - 1. const/let 변수명 = function(){}
                            - 2. function 함수명(){}
        7. 객채(object)     { key : value, key : value, key : value }
                            - 1. key : 1,
                            - 2. key : "유재석",
                            - 3. key : true,
                            - 4. key : [  ],
...
const product = {
    제품명 : '7D 건조 망고' , // key'제품명', value '7D 건조 망고' = 속성 propert
    유형 : '당절임',
...
객체2.method();         // 객체내 속성(매소드) 호출
객체2.객체3.method2();  // 객체내 속성( 객체내 속성(매소드2) 호출 ) 호출
